...
namespace qmapcontrol
{
    ...
    public:
        ...
        void removeLayer (qint32 layerNumber );

        void paintEvent (int mode );
        void setSelectRect(int x, int y, int w, int h);
        void setSelectOrigin(int x, int y);
        void setSelectSize(int w, int h);
         ...
         */
        void setView ( const QmapPoint* point ) const;
        ...
        QPoint worldToScreen(QPointF world);
    ...
    signals:
        ...
        void sendMouseDownEvent ( const QMouseEvent* evnt, const QPointF coordinate );
        void sendMouseReleaseEvent();
        void sendSelectRect(QRectF selectRect);
